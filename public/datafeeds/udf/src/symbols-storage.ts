...
export class SymbolsStorage {
	...
	public constructor(datafeedUrl: string, token: string, datafeedSupportedResolutions: string[], requester: Requester) {
	...
	private _requestExchangeData(exchange: string): Promise<void> {
		return new Promise((resolve: () => void, reject: (error: Error) => void) => {
			this._requester.sendRequest<ExchangeDataResponse>(this._datafeedUrl, this._token, 'symbol_info', { group: exchange })
