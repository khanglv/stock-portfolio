...
var HistoryProvider = /** @class */ (function () {
    function HistoryProvider(datafeedUrl, token, requester) {
    ...
    HistoryProvider.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate) {
        ...
        return new Promise(function (resolve, reject) {
            _this._requester.sendRequest(_this._datafeedUrl, _this._token, 'history', requestParams)
...
var SymbolsStorage = /** @class */ (function () {
    function SymbolsStorage(datafeedUrl, token, datafeedSupportedResolutions, requester) {
    ...
    SymbolsStorage.prototype._requestExchangeData = function (exchange) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._requester.sendRequest(_this._datafeedUrl, _this._token, 'symbol_info', { group: exchange })
                .then(function (response) {
                try {
...
var UDFCompatibleDatafeedBase = /** @class */ (function () {
    function UDFCompatibleDatafeedBase(datafeedURL, token, quotesProvider, requester, updateFrequency) {
        ...
        this._requester = requester;
        this._token = token;
        this._historyProvider = new HistoryProvider(datafeedURL, token, this._requester);
        this._quotesProvider = quotesProvider;
    ...
    UDFCompatibleDatafeedBase.prototype._send = function (urlPath, params) {
        return this._requester.sendRequest(this._datafeedURL, this._token, urlPath, params);
    };
    UDFCompatibleDatafeedBase.prototype._setupWithConfiguration = function (configurationData) {
        ...
        if (configurationData.supports_group_request || !configurationData.supports_search) {
            this._symbolsStorage = new SymbolsStorage(this._datafeedURL, this._token, configurationData.supported_resolutions || [], this._requester);
        }
...
var QuotesProvider = /** @class */ (function () {
    function QuotesProvider(datafeedUrl, token, requester) {
        this._datafeedUrl = datafeedUrl;
        this._requester = requester;
        this._token = token;
    }
    QuotesProvider.prototype.getQuotes = function (symbols) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this._requester.sendRequest(_this._datafeedUrl, _this._token, 'quotes', { symbols: symbols })
                .then(function (response) {
                if (response.s === 'ok') {
                    resolve(response.d);
                }
...
var Requester = /** @class */ (function () {
    ...
    Requester.prototype.sendRequest = function (datafeedUrl, token, urlPath, params) {
        ...
        if (this._headers !== undefined) {
            options.headers = __assign({}, this._headers, { 'Authorization': "jwt " + token, 'Content-Type': 'application/json' });
        }
        else {
            options.headers = {
...
var UDFCompatibleDatafeed = /** @class */ (function (_super) {
    ...
    function UDFCompatibleDatafeed(datafeedURL, token, updateFrequency) {
        if (updateFrequency === void 0) { updateFrequency = 10 * 1000; }
        var _this = this;
        var requester = new Requester();
        var quotesProvider = new QuotesProvider(datafeedURL, token, requester);
        _this = _super.call(this, datafeedURL, token, quotesProvider, requester, updateFrequency) || this;
        return _this;
    }
